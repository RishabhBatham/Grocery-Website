...
import { PhotoCamera,ResetTv } from "@mui/icons-material"
 ...
 const fillallCategory=()=>{
  ...
  const handlechangessubcategory=(subcatid)=>{
    ...
    {/*    //////////////////////////////    SUBCATEGORY dropdown form ////////////////////////////*/}
                   ...
                   <Grid item xs={6}>
                     <TextField label="Productlist Description" error={error.description?true:false } helperText={error.description} onFocus={()=>handleError("description",null)} onChange={(event)=>{setDescription(event.target.value)}} variant="outlined" fullWidth/>
                   </Grid>
                           {/* /////////////////////////////////   Product Rate//////////////////////////////// */}
                         

                   <Grid item xs={6}>
                     <TextField label="Productlist Rate" error={error.rate?true:false } helperText={error.rate} onFocus={()=>handleError("rate",null)} onChange={(event)=>{setRate(event.target.value)}} variant="outlined" fullWidth/>
                   </Grid>
                             {/* /////////////////////////////////   Product Offer//////////////////////////////// */}
                          

                   <Grid item xs={6}>
                     <TextField label="Productlist Offer" error={error.offer?true:false } helperText={error.offer} onFocus={()=>handleError("offer",null)} onChange={(event)=>{setOffer(event.target.value)}} variant="outlined" fullWidth/>
                   </Grid>
                   ...
                   <Grid item xs={4}>
                     <TextField label="Productlist Weight" error={error.weight?true:false } helperText={error.weight} onFocus={()=>handleError("weight",null)} onChange={(event)=>{setWeight(event.target.value)}} variant="outlined" fullWidth/>
                   </Grid>
                                  {/* /////////////////////////////////   Product weight type//////////////////////////////// */}
                                  <Grid item xs={4}>
                        <FormControl fullWidth>
                        <InputLabel id="demo-simple-select-label">type</InputLabel>
                             ...
                             value={type}
                             label="type"
                             error={error.type?true:false} helperText={error.productid}
                             ...
                             >
                                ...
                                <MenuItem>gms</MenuItem>
                                <MenuItem>Liter</MenuItem>
                        ...
                        <div className={classes.errorTxt}>{error.type}</div>
                      </Grid>
                   ...
                   <Grid item xs={4}>
                     <TextField label="Productlist Stock" error={error.stock?true:false } helperText={error.stock} onFocus={()=>handleError("stock",null)} onChange={(event)=>{setStock(event.target.value)}} variant="outlined" fullWidth/>
                   </Grid>
                  {/*//////////////////////////  status//////////////////////////////////// */}
