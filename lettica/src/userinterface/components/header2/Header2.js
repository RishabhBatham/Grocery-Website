...
export default function Header2(){
    ...
    const iconsm = useMediaQuery(theme.breakpoints.down('sm'));
    ...
    return(
        ...
        <div style={{position:'relative',zIndex:'20'}}>
            <AppBar position="static" style={{backgroundColor:'var(--themered)'}}  >
                  <Toolbar>
                   ...
                   <div className="header__logo">
                             ...
                             131.439 140.944C126.809 140.944 126.727 140.883 112.913 127.287ZM74.8882 104.883C85.8266
                              102.362 98.2823 93.4375 103.652 84.275C119.859 56.6204 102.796 22.2788 70.5395
                               17.6318C55.7043 15.4946 42.628 19.6831 31.4285 30.1597C6.77097 53.2256 16.032
                                92.4416 48.7717 103.599C56.1618 106.118 67.1829 106.66 74.8882 104.883Z" fill="var(--white)"/>
                    </svg>
                    ...
                    </div>
                    {
                       ...
                       <div className="header__icons header__cart" style={{color:"var(--white)",display:'flex',justifyContent:'center',alignItems:'center'}}>
                       
                       <Badge badgeContent={totalproducts.length} color="success">
                       <ShoppingBagOutlined onClick={()=>navigate("/mycart")} />
                       </Badge>
                      <FaceOutlined/>
