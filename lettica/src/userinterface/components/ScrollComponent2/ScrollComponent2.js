          ...
          console.log(products)
                return(
                    products.map((item,index)=>{
                        ...
                        return(
                           <div className="scroll5__padding" onClick={()=>handleClick(item)}>
    ...
    return(
      ...
      return(
         ...
         <div>
               ...
               <div className="bannercomp3__textcontainer" >
                     <p></p> 
                     <div className="bannercomp3__bgicon" style={{paddingBottom:'15px'}}>
